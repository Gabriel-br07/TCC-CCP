...
\begin{figure}[H]
  ...
  \IfFileExists{04-figuras/auth.png}{%
    \includegraphics[width=0.65\textwidth]{04-figuras/auth.png}
  }{%
...
\begin{figure}[H]
  ...
  \IfFileExists{04-figuras/inicio.png}{%
    \includegraphics[width=0.75\textwidth]{04-figuras/inicio.png}
  }{%
...
\begin{figure}[H]
  ...
  \IfFileExists{04-figuras/resposta_rag.png}{%
    \includegraphics[width=0.75\textwidth]{04-figuras/resposta_rag.png}
  }{%
...
\begin{figure}[H]
  ...
  \IfFileExists{04-figuras/resposta_simples.png}{%
    \includegraphics[width=0.75\textwidth]{04-figuras/resposta_simples.png}
  }{%
...
\section{Integração entre Interface e Pipeline RAG}
\label{sec:integracao_interface}
